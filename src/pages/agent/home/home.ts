...
import { Api, User, Jobs, Products } from '../../../providers/providers';
...
export class HomePage {
  ...
  constructor(protected productP: Products, protected navParams: NavParams, protected jobs: Jobs, public user: User, public common: CommonProvider, public api: Api, public navCtrl: NavController, public modalCtrl: ModalController) {
    this.requestList = [];
    this.stocks = [];
